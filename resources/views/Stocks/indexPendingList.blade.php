...
<section id="basic-datatable">
	<div class="row">
		<div class="col-sm-12">
			<h2><strong>Stock Inicial</strong> <small>(pendientes)</small></h2>
			<a href="{{ url('stocks/') }}" class="btn btn-primary" style=" position: absolute; right:15px; top:5px;">Ver todos los proyectos (histórico)</a>
		</div>	
	</div>
</section>
			...
			<table class="table table-striped table-bordered complex-headers">
				...
				<tbody>
					...
					<tr>
					    ...
					    <td>
					    	<a href="{{	url('stocks/detalle/'.$get_records->id) }}">
