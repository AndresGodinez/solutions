...
@section('content')
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form class="generic_form form_ligas" action="{{ url('sustitutos/process/set-track/contribute/cancel') }}"
                  method="POST">
                @csrf
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h5><strong>Información del Solicitante</strong></h5>
            </div>
            <div class="col-sm-3">
                <div class="form-group">
            ...
            <div class="col-sm-12">
                <div class="get_txt_desc alert alert-light" role="alert">
                    ...
                    <br/>
                    <strong>Componente Sustituto: </strong> {{ $data[0]->np_sust }}
                    <br/>
                    <strong>Descripción del componente Sustituto: </strong> {{ $data[0]->np_sust }}
                    <br/>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <h5><strong>Historial de Seguimiento</strong></h5>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
