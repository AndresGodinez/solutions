    ...
    <div class="row">
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name="parte" type="text" readonly id="parte" size="40"
                       value="<?php echo($row['no_parte']);?>">
            </fieldset>
        </div>
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name="descripcion" type="text" readonly id="descripcion" size="40"
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name="descripcion" type="text" readonly id="descripcion" size="40"
                       value="<?php echo($row['tipo_material']);?>">
            </fieldset>
        </div>
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name='username' type='text' readonly id='username' size="40"
                       value='<?php echo($row['sir_anual']);?>'>
            </fieldset>
        </div>
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name='motivo' type='text' readonly id='motivo' size='40'
                       value='<?php echo($row['proyecto']);?>'>
            </fieldset>
        </div>
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name='motivo' type='text' readonly id='motivo' size='40'
                       value='<?php echo($row['produccion_inicial']);?>'>
            </fieldset>
        </div>
        ...
        <div class="col-3">
            <fieldset class="form-group">
                ...
                <input class="form-control" name='motivo' type='text' readonly id='motivo' size='40'
                       value='<?php echo($row['vol_vta_anual']);?>' required/>
            </fieldset>
        </div>
        ...
        <div class="col-12">
            <fieldset class="form-group">
                ...
                <textarea class="form-control" name="comentario" readonly id="comentario" rows="4" cols="41"
                          style="text-transform:uppercase"><?php echo($row['comentario']);?></textarea>
            </fieldset>
        </div>
        ...
        <div class="col-12">
            <fieldset class="form-group">
                ...
                <select name="conclusion" id="conclusion" onChange="return validateR(this.value);"
                        class="validate[required] textarea form-control formulariovalidacion">
        ...
        <div id="otros" style="display:none" class="col-12">
            <fieldset class="form-group">
                ...
                <input class="form-control" type="text" maxlength="20" id="po" name="po"
        ...
        <div id="otros2" style="display:none" class="col-12">
            <fieldset class="form-group">
                ...
                <select align="right" name="tipo_conclusion" id="tipo_conclusion"
                        onChange="return validateR(this.value);" class="validate[required] textarea form-control">
                    <option value="">Selecciona</option>
        ...
        <div id="otros3" style="display:none" class="col-12">
            <fieldset class="form-group">
                ...
                <input class="form-control" type="text" maxlength="20" id="no_sust" name="no_sust"
                       style="text-transform:uppercase"/>
            </fieldset>
        </div>
        ...
        <div class="col-12">
            <fieldset class="form-group">
                ...
                <textarea name="comentario" id="comentario" rows="5" style="text-transform:uppercase"
                          class="validate[required] textarea form-control formulariovalidacion"></textarea>
            </fieldset>
        </div>
...
<script>
    ...
    function validateR() {
        ...
        let tipo_conclusion = document.getElementById('tipo_conclusion').value;
