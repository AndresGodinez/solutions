...
<script type="text/javascript" src="https://soluciones.refaccionoriginal.com/lar/js/zebra/js/deployJava.js"></script>
...
// AQUI AGREGUE DEFAULT IMPRESORA
          ...
          // Searches for locally installed printer with "zebra" in the name
			 if (qz != null) {
			  		qz.appendFile("D:/inetpub/wwwroot/Soluciones2/app/Http/Controllers/zebra/etiqueta.txt");
			    	qz.print();	
			 	}
// TERMINA
	...
	*/
	function qzDonePrinting() {
		...
		window.location.href = "https://soluciones.refaccionoriginal.com/lar/nom-comerciales/process/impresion/";
	}
	...
	***************************************************************************/
	...
	<script type="text/javascript" src="https://soluciones.refaccionoriginal.com/lar/js/zebra/js/jquery-1.10.2.js"></script>
	<script type="text/javascript" src="https://soluciones.refaccionoriginal.com/lar/js/zebra/js/html2canvas.js"></script>
	<script type="text/javascript" src="https://soluciones.refaccionoriginal.com/lar/js/zebra/js/jquery.plugin.html2canvas.js"></script>
	</head>
...
$descripcion=substr(strtoupper("SDFSDFSDFSD"),0,20).' '.$piezas.'PIEZAS';
...
$myfile = fopen("D:/inetpub/wwwroot/Soluciones2/app/Http/Controllers/zebra/etiqueta.txt", "w") or die("Unable to open file!");
$txt = $etiqueta;
fwrite($myfile, $txt);
fclose($myfile);
