...
<section id="basic-datatable">
	<div class="row">
		<div class="col-sm-12">
			<h2><strong>Editar Existente</strong></h2>			
		</div>
	</div>
</section>
				...
				<table class="table table-striped table-bordered complex-headers table-responsive">
					...
					<tbody>
						...
						<tr>
                            ...
                            <td>
                                <a href="{{	url('ingexp/editar/'.$get_records['idregistro']) }}" class="btn btn-success" style="width: 100%;">Editar</a>
                            </td>	
...
<script>    
        ...
        $('.filtro').on('change',function(){
            var tipo = $('#tipo').val();
            var linea = $('#linea').val();
            window.location = '<?php echo url('/ingexp/editar/'); ?>?tipo='+tipo+'&linea='+linea
        });
