    ...
    <div class="container">
        ...
        @canany(['carga mm60', 'carga fecha creacion piezas'])
            <div class="form-row">
                ...
                @endcan
                @can('carga fecha creacion piezas')
                    <div class="form-group col-md-6">
                        <form action="{{route('sustitutos.carga-fecha-creacion-piezas')}}" method="post"
        ...
        @canany(['carga inventarios', 'carga masiva sustitutos'])

            <div class="form-row">
                @can('carga inventarios')
                    <div class="form-group col-md-6">
                        <form action="{{ route('sustitutos.carga-inventarios') }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                ...
                @endcan
                @can('carga masiva sustitutos')
                    <div class="form-group col-md-6">
                        <form action="{{ route('sustitutos.carga-masiva-sustitutos') }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            <label for="carga_masiva">Carga Masiva Sustitutos</label>
                            <p class="alert alert-warning">
                                <strong> **AQUÍ puedes cargar tu archivo generado de SAP para actualizar los sustitutos
                                    en
