...
<div class="card">		
	<div class="card-body">
		<form name='forma' action="{{ url('/alcopar/oow/oowprocess/')}}" id='formID' method='POST'>
		@csrf
			<div class="row">
				...
				<div class="col-md-12 col-12">
					<fieldset class="form-group">
						...
						<select name="asigna" class="form-control">
							<option value="">Escoge un m&oacute;duloo </option>
				...
				<div class="col-md-12 col-12 mt-2">
						<fieldset class="form-group">
							...
							<a class="btn btn-primary"  value="" href="{{ url('/alcopar/oow')}}">Regresar al Listado</a>
							</center>
						</fieldset>
				</div>		
			</div>			
